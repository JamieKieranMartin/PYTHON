...
random_numbers = []
num_of_trials = randint(0, 10)
for numbers in range(num_of_trials):
    randnum =  randint(0, num_of_trials)
    random_numbers.append(randnum)
    print(randnum)

print("Number of trials:", num_of_trials)
print("Your maximum random number was", max(random_numbers))
print("Your maximum random number was", min(random_numbers))
